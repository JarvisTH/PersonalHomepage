...
<div class="container">
    ...
    <%
        ...
        System.out.println(userId+"qqqqq");
    ...
    <div class="content">
        <div class="sec">
            <form action="${pageContext.request.contextPath}/Servlet/ProjectFileServlet?method=modify&index=<%=index%>&userId=<%=userId%>" method="post">
                <div class="input-line">
                    <label>Project Name:</label>
                    <input type="text" class="input-field" name="project-name" value="<%=project.getProName()%>">
                </div>
                <div class="input-line">
                    <label >Experience:</label>
                    <textarea name="exp-txt" id="" class="txt" cols="80" rows="5">
